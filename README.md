...
|#|TOPIC|DESCRIPTION|
|--|--|--|
|00|[Read first](foundation/docs/ai-agent-explain.md)|Overview of AI agents: what they are and why they are necessary.![](foundation/docs/img/Agent-general.png)|
|01|[Funny compare LLM vs CPU](foundation/docs/llm-cpu.md)|Brains, Bytes, and Blueprints: Why the LLM-as-CPU Metaphor Rocks (Until It Doesn't)![](foundation/docs/img/llm-cpu.png)|
